...
jax_requirements = [
    'jax==0.4.3',
    'jaxlib @ https://storage.googleapis.com/jax-releases/cuda11/jaxlib-0.4.3+cuda11.cudnn82-cp310-cp310-manylinux2014_x86_64.whl',
    'chex',
    'dm-haiku',
    'flax',
    'optax',
...
testing_requirements = [
    'pytype==2022.4.15',  # TODO(b/206926677): update to new version.
    'pytest-xdist',
]
